...
/**
 * In-memory token bucket rate limiter for MCOS command execution.
 *
...
enum class RateLimitKind(val key: String) {
    ...
    internal fun maxTokens(r: RateLimiter): Int = when (this) {
        INVOKE_PER_MINUTE -> r.maxInvokesPerMinute
        DESTRUCTIVE_PER_HOUR -> r.maxDestructivePerHour
    }
