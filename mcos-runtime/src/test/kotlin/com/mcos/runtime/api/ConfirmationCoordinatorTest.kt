...
import com.mcos.runtime.events.EventEnvelope
import com.mcos.runtime.events.EventFilter
import com.mcos.runtime.events.EventSubscription
            ...
            override fun handlers(): Map<String, CommandHandler> =
                mapOf(
                    "test.write" to object : CommandHandler {
                        override suspend fun invoke(ctx: com.mcos.sdk.ExecutionContext): CommandResult =
