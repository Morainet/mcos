...
class RateLimiterTest {
    ...
    fun `R1-normal invocation within limits returns Allowed`() {
        val limiter = RateLimiter(maxInvokesPerMinute = 60, maxDestructivePerHour = 5)
    ...
    fun `R2-exceeding invoke limit returns Limited`() {
        val limiter = RateLimiter(maxInvokesPerMinute = 3, maxDestructivePerHour = 5)
    ...
    fun `R3-destructive operations have separate stricter limits`() {
        val limiter = RateLimiter(maxInvokesPerMinute = 60, maxDestructivePerHour = 2)
    ...
    fun `R4-tokens refill after window passes`() {
        ...
        val limiter = RateLimiter(maxInvokesPerMinute = 600, maxDestructivePerHour = 100)
    ...
    fun `R6-getRemainingTokens reports correct counts`() {
        val limiter = RateLimiter(maxInvokesPerMinute = 10, maxDestructivePerHour = 5)
    ...
    fun `R8-read commands do not consume destructive tokens`() {
        val limiter = RateLimiter(maxInvokesPerMinute = 100, maxDestructivePerHour = 5)
