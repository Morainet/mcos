...
class PackageBoundariesTest {
    ...
    private val packageRules = listOf(
        ...
        "com.morainet.mcos.android.demo" to "mcos-android",
        "com.morainet.mcos.android" to "mcos-android-sdk",
        ...
        "com.morainet.mcos.plugin.intent" to "plugins:mcos-plugin-intent",
