package com.morainet.mcos.runtime.plugin
...
class PluginLoaderTest {
    ...
    private fun sign(pair: java.security.KeyPair, payload: ByteArray): com.morainet.mcos.runtime.security.ArtifactSignature {
        val signer = java.security.Signature.getInstance("Ed25519")
        signer.initSign(pair.private)
        signer.update(payload)
        val bytes = signer.sign()
        return com.morainet.mcos.runtime.security.ArtifactSignature(
