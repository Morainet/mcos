...
import com.morainet.mcos.runtime.registry.RegisterResult
...
class PluginLoader(
    ...
    fun load(
        ...
        return when (decision) {
            is com.morainet.mcos.runtime.security.TrustDecision.Allow -> {
            ...
            is com.morainet.mcos.runtime.security.TrustDecision.Deny -> LoadResult.Denied(
                pluginId = packageId,
