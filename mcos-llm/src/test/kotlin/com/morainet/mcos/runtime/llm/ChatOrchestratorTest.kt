...
import com.morainet.mcos.runtime.api.*
...
class ChatOrchestratorTest {
    ...
    fun `O12-injection with untrusted snippet and high-risk command`() = runBlocking {
        ...
        val detection = detector.detect(
            ...
            commands = listOf(
                com.morainet.mcos.runtime.executor.Command("sys.delete", kotlinx.serialization.json.JsonObject(mapOf("path" to kotlinx.serialization.json.JsonPrimitive("/system"))))
            ),
        )
