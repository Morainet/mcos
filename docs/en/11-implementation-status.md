...
**Next up (suggested):** the cloud-sync Memory tier (06 §16), then higher-fidelity grammar injection (GBNF/Outlines backend for CONSTRAINED) and PlanMode `LATENCY_TIERED` (§17 V3).
